...
INSERT INTO `tbl_book` VALUES ('6', '历史', '《丰乳肥臀》', '以色列新锐历史学家尤瓦尔·赫拉利代表作，第十届文津图书奖获奖作品');
INSERT INTO `tbl_book` VALUES ('7', '人生奥义', '《生死疲劳》', '吕思勉先生写给普通读者的中国通史入门书，用白话文写成的中国通史，把历史从“帝王的家谱”转变为人类的进化史');
...
INSERT INTO `tbl_book` VALUES ('21', '哲学', '《金刚经》', '过去心不可得');
INSERT INTO `tbl_book` VALUES ('22', '哲学', '《般若波罗蜜心经》', '大慈大悲');
